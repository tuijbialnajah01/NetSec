...
import { Shield, Lock, Hexagon, AlertOctagon, Terminal } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg font-bold tracking-tight text-white">Net<span className="text-emerald-500">Sec</span> Index</span>
            </div>
          </div>
        </div>
      </nav>
